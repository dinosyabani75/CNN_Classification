...
public class CameraPredict extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_camera_predict);

        imageView = findViewById(R.id.action_image);
        Button take_pic = findViewById(R.id.take_picture);
    ...
    public void classifyImage(Bitmap image){
        try {
            ...
            ModelFreshRottenFruitPart3 modelFreshRottenFruitPart3 = ModelFreshRottenFruitPart3.newInstance(getApplicationContext());
            ...
            //ModelFreshRottenFruit.Outputs outputs = model.process(inputFeature0);
            ModelFreshRottenFruitPart3.Outputs outputs = modelFreshRottenFruitPart3.process(inputFeature0);
            ...
            for(int i = 0; i < classes.length; i++){
                s += String.format("This Picture Is: "+"%s: %.1f%%\n", classes[i], confidences[i]);
            }
